...
function renderAbout() {
  ...
  document.getElementById('about-content').innerHTML = `
    <span class="section-label section-label--blush">${about.label}</span>
    ...
    <ul class="about__highlights">
      ${about.highlights.map((item) => `
        <li class="about__highlight card-bakery">
          <span class="about__highlight-icon">${item.icon}</span>
...
function renderNav() {
  ...
  document.getElementById('hero-image').src = encodeURI(SITE_DATA.images.hero)
  document.getElementById('about-image').src = encodeURI(SITE_DATA.images.about)
...
function initForm() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      // clipboard may be unavailable — still open VK
    }
